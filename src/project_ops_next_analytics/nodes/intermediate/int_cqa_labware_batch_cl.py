...
def int_create_cqa_labware_batch_cl_data(
    spark_df: sql.DataFrame, param: Dict,
) -> sql.DataFrame:
    """
    This function reads cqa labware batch data and perform cleaning, data type conversion on it.
    Args:
        spark_df: cqa labware batch data
        param: parameters

    Returns: Cleaned cqa labware batch data for a given plant.
    ...
    df = convert_to_date(
        df,
        {
            "batch_created_on": "yyyy-MM-dd HH:mm:ss",
