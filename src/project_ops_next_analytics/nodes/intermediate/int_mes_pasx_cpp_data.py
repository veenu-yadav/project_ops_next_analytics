...
def int_create_mes_pasx_cpp_data(
    spark_df: sql.DataFrame, param: Dict,
) -> sql.DataFrame:
    """
    This function reads cpp data from mes pasx and perform cleaning, data type conversion on it.
    Args:
        spark_df: cpp data from mes pasx
        param: parameters

    Returns: Cleaned cpp data from mes pasx for a given plant
    ...
    df = convert_to_date(
        df,
        {
            ...
            "record_datetime_yyyy_mm": "yyyy_MM",
        },
    )
