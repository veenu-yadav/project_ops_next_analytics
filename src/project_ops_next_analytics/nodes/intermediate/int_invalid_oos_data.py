...
def int_create_invalid_oos_data(pandas_df: sql.DataFrame) -> sql.DataFrame:
    """
    This function reads invalid oos data and perform cleaning, data type conversion on it.
    Args:
        pandas_df: invalid oos data

    Returns: Cleaned invalid oos data.
    ...
    outputschema = StructType(
        [
            ...
            StructField("oos_no", StringType(), True),
            StructField("reported_on", DateType(), True),
            StructField("status", StringType(), True),
            StructField("batch_no", StringType(), True),
            StructField("test", StringType(), True),
            StructField("market", StringType(), True),
            StructField("ip_fp_stability__rm_pm", StringType(), True),
            StructField("analyst_emp_code", StringType(), True),
            StructField("category", StringType(), True),
            StructField("laboratory_error_categorization", StringType(), True),
            StructField("date_of_disposal", DateType(), True),
